# plan.md：C++ 主线系统工程 / AI Infra 准备路线（加入 6.S081 与 15-445 穿插版）
...
CMU 15-445：后置到中间件阶段，服务 Mini Redis / MySQL / 存储系统理解
```
...
| 阶段 3 | 2027.1 ~ 2027.4 | 中间件项目主线 | Mini Redis、Redis 原理、MySQL 原理、15-445 选学、benchmark、gtest、valgrind |
