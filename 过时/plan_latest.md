# plan.md：C++ 主线系统工程 / AI Infra 准备路线（面试驱动增强版）

> 版本：2026-07-05  
> 定位：近期去掉 Go，先把 **C++ / Linux / OS / 网络 / 系统项目 / 面试表达** 打硬。  
...
Day1 ~ Day3 你之前都接触过，所以推进快是正常的。后面仍然保持：
...
本科就业
优先找技术密度高的实习
长期往基础架构 / 云平台 / 中间件 / AI Infra 方向延展
```

所以主线必须以 C++、Linux、OS、网络、系统项目为核心。
...
| 阶段 1 | 当前 ~ 2026.10 | ACM 主线 + 工程底座 | 现代 C++、Linux 工具链、OS、网络基础、少量面试题 |
| 阶段 2 | 2026.10 ~ 2027.1 | C++ 系统编程入门项目 | 阻塞队列、线程池、异步日志、TCP Server、epoll、Reactor |
| 阶段 3 | 2027.1 ~ 2027.4 | 中间件项目主线 | Mini Redis、Redis 原理、MySQL 原理、benchmark、gtest、valgrind |
...
## 6.11 Redis / MySQL / Nginx / Kafka 中间件
